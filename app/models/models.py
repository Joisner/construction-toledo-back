...
class Budget(Base):
    ...
    clientName = Column('clientname', String)
    clientAddress = Column('clientaddress', Text)
    clientDNI = Column('clientdni', String, nullable=True)
    clientPhone = Column('clientphone', String, nullable=True)
    clientEmail = Column('clientemail', String, nullable=True)
    items = Column(JSON)
    taxRate = Column('taxrate', String, nullable=True)
    validUntil = Column('validuntil', DateTime, nullable=True)
